            ...
            <div class="intro-y col-span-12 flex flex-wrap xl:flex-nowrap items-center mt-2">
                <div class="flex w-full sm:w-auto">
                    <div class="w-48 relative text-slate-500">
                        <input type="text" class="form-control w-48 box pr-10" placeholder="Cari...">
                ...
                <table class="table table-report -mt-2">
                    <thead>
                        <tr>
                            ...
                            <th class="whitespace-nowrap">NAMA PEMESAN</th>
                        ...
                        <?php foreach ($invoice as $row) : ?>
                            ...
                            <tr class="intro-x">
                                ...
                                <?php } else if ($row->status == "1"){ ?>
                                    <div class="flex items-center whitespace-nowrap text-warning"> <b>SUDAH DI KONFIRMASI</b> </div>
                                <?php } ?>
                            </td>
                            <td class="table-report__action"><center>
                                <?php if ($row->status == "0"){ ?>
                                    <div class="flex justify-center items-center">
                                        <a class="flex items-center text-primary whitespace-nowrap" href="<?= site_url('admin/invoice/confirm/'. $row->order_id) ?>"> <i data-lucide="arrow-left-right" class="w-4 h-4 mr-1"></i> Rubah Status Pembayaran </a>
                                    </div>
                                <?php } else if ($row->status == "1"){ ?>
