                                    ...
                                    <div class="grid grid-cols-12 gap-x-5">
                                        ...
                                        <div class="col-span-12 2xl:col-span-6">
                                            <div class="mt-3 2xl:mt-0">
                                                <label for="update-profile-form-3" class="form-label">Stock Produk</label>
                                                <input id="update-profile-form-1" type="number" class="form-control" name="stok" value="<?= $row->stok ?>">
                                            </div>
                                            <div class="mt-3">
                                                <label for="update-profile-form-4" class="form-label" placeholder="cantumkan harga tanpa titik ataupun koma">Harga Produk</label>
