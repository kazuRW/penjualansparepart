            ...
            <div class="grid grid-cols-12 gap-6">
                        ...
                        <div class="box p-5">
                            <ul class=" nav nav-pills w-4/5 bg-slate-100 dark:bg-black/20 rounded-md mx-auto " role="tablist">
                                <li id="active-users-tab" class="nav-item flex-1" role="presentation">
                                    <button class="nav-link w-full py-1.5 px-2 active"> Ulasan Order </button>
                                </li>
                            </ul>
                ...
                <div class="col-span-12 sm:col-span-6 lg:col-span-4 xl:col-span-8 mt-2 lg:mt-6 xl:mt-2">
                    ...
                    <div class="mt-5">
                        ...
                        <?php endforeach; ?>
                        <a href="<?= site_url('admin/invoice') ?>" class="intro-y w-full block text-center rounded-md py-4 border border-dotted border-slate-400 dark:border-darkmode-300 text-slate-500">Lihat Lainnya</a>
                    </div>
                </div>
                <!-- END: Users By Age -->
