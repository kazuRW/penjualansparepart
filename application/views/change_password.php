                            ...
                            <div class="intro-y box lg:mt-5">
                                ...
                                <div class="p-5">
                                    ...
                                    <div class="mt-1">
                                        ...
                                        <input id="change-password-form-2" placeholder="Masukan Password Baru" type="password" name="new_password" class="form-control" autocomplete="off">
                                    </div>
                                    ...
                                    <div class="mt-3 mb-4">
                                        ...
                                        <input id="change-password-form-3" placeholder="Masukan Konfirmasi Password Baru" name="confirm_password" type="password" class="form-control" autocomplete="off">
                                    </div>
