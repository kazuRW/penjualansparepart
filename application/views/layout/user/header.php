        ...
        <div class="h-full flex items-center">
            ...
            <nav aria-label="breadcrumb" class="-intro-x h-full mr-auto">
                <ol class="breadcrumb breadcrumb-light">
                    <li class="breadcrumb-item active" aria-current="page"><a href="<?= site_url('dashboard') ?>">Beranda</a></li>
            ...
            <div class="intro-x dropdown mr-4 sm:mr-6">
                ...
                <div class="notification-content pt-2 dropdown-menu">
                    <div class="notification-content__box dropdown-content">
                        <div class="notification-content__title"> <?php $keranjang = 'Keranjang Belanja : ' . $this->cart->total_items() . ' item ' ?>&nbsp; <?php echo $keranjang ?></div>
                        ...
                        <br>
                        <hr>
                        <button class="btn btn-sm btn-rounded-primary mt-4"><span class="text-uppercase"><a href="<?= site_url('dashboard/detail_cart') ?>">Keranjang Belanja</a></span></button>
                    </div>
                </div>
            </div>
            <!-- END: Notifications -->
            ...
            <div class="intro-x dropdown w-8 h-8">
                ...
                <div class="dropdown-menu w-56">
                    <ul class="dropdown-content bg-primary/80 before:block before:absolute before:bg-black before:inset-0 before:rounded-md before:z-[-1] text-white">
                        ...
                        <li>
                            <a href="<?= site_url('profile') ?>" class="dropdown-item hover:bg-white/5"> <i data-lucide="user" class="w-4 h-4 mr-2"></i> Profil Saya </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="<?= site_url('welcome/logout') ?>" class="dropdown-item hover:bg-white/5"> <i data-lucide="toggle-right" class="w-4 h-4 mr-2"></i> Keluar </a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="wrapper-box">
            ...
            <nav class="side-nav">
                <ul>
                    ...
                    <li>
                        <a href="<?= base_url('ongkoskirim') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="file-text"></i> </div>
                            <div class="side-menu__title"> Cek Ongkir  </div>
                        </a>
                    </li>
