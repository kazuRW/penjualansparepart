        ...
        <div class="wrapper-box">
            ...
            <nav class="side-nav">
                <ul>
                    ...
                    <li>
                        <a href="<?= base_url('categories/processor') ?>" class="side-menu side-menu">
                    ...
                    <li>
                        <a href="<?= base_url('categories/vga') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="shopping-bag"></i> </div>
                            <div class="side-menu__title">
                                VGA
                    ...
                    <li>
                        <a href="<?= base_url('categories/ssd') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="shopping-bag"></i> </div>
                            <div class="side-menu__title"> SSD </div>
                        </a>
                    </li>
                    <li>
                        <a href="<?= base_url('categories/ram') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="shopping-bag"></i> </div>
                            <div class="side-menu__title"> RAM </div>
                        </a>
                    </li>

                    <li>
                        <a href="<?= base_url('categories/produklainnya') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="shopping-bag"></i> </div>
                            <div class="side-menu__title"> Produk lainnya </div>
                        </a>
                    </li>
