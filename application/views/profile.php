<div class="content">
    ...
    <div class="intro-y box px-5 pt-5 mt-5">
        <div class="flex flex-col lg:flex-row border-b border-slate-200/60 dark:border-darkmode-400 pb-5 -mx-5">
            <div class="flex flex-1 px-5 items-center justify-center lg:justify-start">
                ...
                <div class="ml-5">
                    ...
                    <div class="text-slate-500">RMZParts Pelanggan</div>
                </div>
            </div>
            <div class="mt-6 lg:mt-0 flex-1 px-5 border-l border-r border-slate-200/60 dark:border-darkmode-400 border-t lg:border-t-0 pt-5 lg:pt-0">
                ...
                <div class="flex flex-col justify-center items-center lg:items-start mt-4">
                    ...
                    <div class="truncate sm:whitespace-normal flex items-center mt-3"> <i data-lucide="slack" class="w-4 h-4 mr-2"></i> Pelanggan </div>
        ...
        <ul class="nav nav-link-tabs flex-col sm:flex-row justify-center lg:justify-start text-center" role="tablist">
            <li id="dashboard-tab" class="nav-item" role="presentation"> <a href="javascript:;" class="nav-link py-4 active" data-tw-target="#dashboard" aria-controls="dashboard" aria-selected="true" role="tab"> Beranda </a> </li>
            <li id="account-and-profile-tab" class="nav-item" role="presentation"> <a href="javascript:;" class="nav-link py-4" data-tw-target="#account-and-profile" aria-selected="false" role="tab"> Perbarui Profil </a> </li>
        </ul>
    </div>
    <!-- END: Profile Info -->
                        ...
                        <div class="tab-content">
                            <div id="work-in-progress-new" class="tab-pane active" role="tabpanel" aria-labelledby="work-in-progress-new-tab">
                                <?php foreach ($bill as $row) : ?>
                                    <div class="mt-2 mb-5">
                                        <div class="flex">
                                            <div class="mr-auto">ID Pesanan : <b>#<?= $row->order_id ?></b></div>
                                            <div>
                                ...
                                <?php endforeach; ?>
                                <br>
                                <a href="<?= site_url('bill') ?>" class="btn btn-secondary block w-40 mx-auto mt-5">Lihat Lebih Lanjut</a>
                            </div>
                        </div>
                    </div>
                </div>
                                            ...
                                            <?php foreach ($profile as $row) : ?>
                                                <div class="grid grid-cols-12 gap-x-5">
                                                    <div class="col-span-12 2xl:col-span-6">
                                                        <div>
                                                            <label for="update-profile-form-1" class="form-label">Nama Kamu</label>
                                                            <input type="hidden" name="id_user" value="<?= $row->id_user ?>">
                                                            <input id="update-profile-form-1" type="text" class="form-control" name="nama_user" required autocomplete="off" placeholder="Masukan Nama" value="<?= $row->nama_user ?>">
                                                        </div>
                                                        <div class="mt-3">
                                                            <label for="update-profile-form-2" class="form-label">Email Kamu</label>
                                                            <input id="update-profile-form-1" type="email" class="form-control" name="email" required autocomplete="off" placeholder="Masukan Email" value="<?= $row->email ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            <?php endforeach; ?>
