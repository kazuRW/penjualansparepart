                                    ...
                                    <tr class="intro-x">
                                        ...
                                        <td class="text-center">
                                         ...
                                         <td>
                                            ...
                                            <div class="flex items-center whitespace-nowrap text-danger text-uppercase"> <i data-lucide="package" class="w-4 h-4 mr-2"></i> <b>POS</b> </div>
                                ...
                                <div class="modal-body p-0">
                                    <div class="p-5 text-center">
                                        ...
                                        <div class="text-slate-500 mt-2">
                                            Apakah kamu ingin menghapus riwayat ?
                                            <br>
                                            Proses ini tidak akan mengembalikan data.
                                        </div>
                                    </div>
