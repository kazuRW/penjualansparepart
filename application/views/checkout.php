                    ...
                    <form id="payment-form" action="<?= site_url('dashboard/checkout_proccess') ?>" method="post">
                        <div id="content" class="tab-pane p-5 active" role="tabpanel" aria-labelledby="content-tab">
                            <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                                <div class="font-medium flex items-center border-b border-slate-200/60 dark:border-darkmode-400 pb-5"> <i data-lucide="chevron-down" class="w-4 h-4 mr-2"></i> Data Pelanggan </div>
                                <div class="mt-5">
                                    <div class="mb-5">
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <input type="text" id="mobile_phone" name="mobile_phone" class="form-control" placeholder="nomor Handphone Kamu" autocomplete="off" required>
                                    </div>
                                </div>
                            </div>
                            <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5 mt-5">
                                ...
                                <div class="mt-5">
                                    <div class="mb-5">
                                        <label for="post-form-7" class="form-label">Alamat Kamu <small class="text-danger">*</small></label>
                                        <input type="text" id="alamat" name="alamat" class="form-control" placeholder="Alamat Lengkap, JL." autocomplete="off" required>
                                    </div>
            ...
            <div id="ticket" class="tab-pane active" role="tabpanel" aria-labelledby="ticket-tab">
                <div class="box p-2 mt-5">
                    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#add-item-modal" class="flex items-center p-3 cursor-pointer transition duration-300 ease-in-out bg-white dark:bg-darkmode-600 hover:bg-slate-100 dark:hover:bg-darkmode-400 rounded-md">
                        ...
                        <div class="ml-auto font-medium">5211231654 / RMZParts</div>
                    </a>
                    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#add-item-modal" class="flex items-center p-3 cursor-pointer transition duration-300 ease-in-out bg-white dark:bg-darkmode-600 hover:bg-slate-100 dark:hover:bg-darkmode-400 rounded-md">
                        <div class="max-w-[50%] truncate mr-1">
                ...
                <div class="box p-5 mt-5">
                    ...
                    <div class="flex mt-4 pt-4 border-t border-slate-200/60 dark:border-darkmode-400">
                        <div class="mr-auto font-medium text-base">Total Yang Harus Dibayar</div>
                        <div class="font-medium text-base"><strong>Rp. <?= number_format($this->cart->total(), 0, ',', '.') ?>,-</strong></div>
                    </div>
                </div>
                <br><span class="flex mt-4 text-danger">Catatan penting * = Total Harga yang harus dibayar diatas belum termasuk harga Ongkos kirim,harap jumlahkan dari Total yang harus dibayar + harga ongkos kirim, lalu kirim bukti transfer, Terimakasih</span><br>
                <br><p>Silahkan cek ongkos kirim pada tombol di bawah ini</p><br>
                <a href="../ongkoskirim" target="_blank"><button class="btn btn-primary w-40 shadow-md ml-auto">Cek Harga Ongkir dari tujuan awal ke tujuan kamu</button></a>
            </div>
        </div>
        <!-- END: Post Info -->
    </div>
